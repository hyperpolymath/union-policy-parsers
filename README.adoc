...
:experimental:
:url-github: https://github.com/hyperpolymath/union-policy-parsers
:url-gitlab: https://gitlab.com/hyperpolymath/union-policy-parsers
:url-bitbucket: https://bitbucket.org/hyperpolymath/union-policy-parsers
:url-codeberg: https://codeberg.org/hyperpolymath/union-policy-parsers

Union and labor policy document parsers
...
union-policy-parsers is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
